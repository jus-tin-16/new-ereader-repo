...
import {
  Button_default
} from "./chunk-OHWCBZKR.js";
import "./chunk-EHHS7NSL.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Modal = React46.forwardRef(({
  ...
  const renderBackdrop = (0, import_react11.useCallback)((backdropProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...backdropProps,
...
var Tooltip = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime54.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames47.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
  ...
  return (0, import_jsx_runtime55.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React53.cloneElement(overlay, {
        ...
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames48.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime58.jsxs)(import_jsx_runtime57.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react16.cloneElement)(children, triggerProps), (0, import_jsx_runtime56.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React55.forwardRef(({
  ...
  return (0, import_jsx_runtime59.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames49.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime60.jsxs)(Component2, {
      className: (0, import_classnames49.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime61.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames50.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames51.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime64.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames52.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var Ratio = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime65.jsx)("div", {
    ...
    className: (0, import_classnames53.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React61.forwardRef(({
  ...
  return (0, import_jsx_runtime66.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames54.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames55.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React63.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime69.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime68.jsx)(Button_default, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime68.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime68.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var Stack = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames56.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var TabPanel = React65.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime71.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime71.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime71.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime71.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime73.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React68.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React69.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
    ...
    children: (0, import_jsx_runtime75.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime75.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime75.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames58.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime77.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime77.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime78.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime77.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime77.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime77.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React72.forwardRef((props, ref) => (0, import_jsx_runtime79.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React74.forwardRef(({
  ...
  return (0, import_jsx_runtime81.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames60.default)(bsPrefix, className),
...
var Toast = React76.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime83.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames62.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime83.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime83.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React77.forwardRef(({
  ...
  return (0, import_jsx_runtime84.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames63.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var ToggleButton = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime87.jsxs)(import_jsx_runtime86.Fragment, {
    children: [(0, import_jsx_runtime85.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime85.jsx)(Button_default, {
      ...props,
      ref,
      className: (0, import_classnames64.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React79.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime88.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
